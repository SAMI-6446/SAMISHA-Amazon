...
class Product {
  ...
  constructor(productDtails) {
    this.id = productDtails.id;
    this.image = productDtails.image;
    this.name = productDtails.name;
    this.rating = productDtails.rating;
    this.priceCents = productDtails.priceCents;
  }
  getStarsUrl() {
...
class Clothing extends Product {
  ...
  constructor(productDtails) {
    super(productDtails);
    this.sizeChartLink = productDtails.sizeChartLink;
  }
